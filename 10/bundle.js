...
const generatePoint = () => {
  ...
  const locationArray = (0,_destinations__WEBPACK_IMPORTED_MODULE_2__.destinations)();
  const pointArray = (0,_offers__WEBPACK_IMPORTED_MODULE_1__.offers)();
  return {
...
/* harmony export */ });
/* harmony import */ var _view_content_items_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/content-items-view */ "./src/view/content-items-view.js");
/* harmony import */ var _view_edit_item_event_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/edit-item-event-view */ "./src/view/edit-item-event-view.js");
...
class PointPresenter {
  constructor(tripPointsListElement, changeData, changeMode) {
    ...
    _defineProperty(this, "init", tripPoint => {
      ...
      _classPrivateFieldSet(this, _pointItemComponent, new _view_content_items_view__WEBPACK_IMPORTED_MODULE_0__["default"](tripPoint));

      _classPrivateFieldSet(this, _pointEditComponent, new _view_edit_item_event_view__WEBPACK_IMPORTED_MODULE_1__["default"](tripPoint));
...
/* harmony import */ var _view_empty_list_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/empty-list-view */ "./src/view/empty-list-view.js");
...
var _emptyEventList = /*#__PURE__*/new WeakMap();
...
var _renderEmptyList = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(mainElement) {
    ...
    _classPrivateFieldInitSpec(this, _sortComponent, {
      writable: true,
      value: new _view_sort_view__WEBPACK_IMPORTED_MODULE_2__["default"]()
    });

    _classPrivateFieldInitSpec(this, _emptyEventList, {
      writable: true,
      value: new _view_empty_list_view__WEBPACK_IMPORTED_MODULE_1__["default"]()
    });
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY
    });
    ...
    _defineProperty(this, "init", point => {
      ...
      _classPrivateFieldSet(this, _sourcedTripPoints, [...point]);

      _classPrivateFieldGet(this, _renderMain).call(this);
    });

    _classPrivateFieldInitSpec(this, _renderEmptyList, {
      writable: true,
      value: () => {
        (0,_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _emptyEventList), _render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripEventsListElement, {
      writable: true,
      value: () => {
        (0,_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _tripEventsListElement), _render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _handleTaskChange, {
      writable: true,
      value: updatedPoint => {
        _classPrivateFieldSet(this, _point, (0,_utils_common__WEBPACK_IMPORTED_MODULE_5__.updateItem)(_classPrivateFieldGet(this, _point), updatedPoint));
    ...
    _classPrivateFieldInitSpec(this, _sortTasks, {
      ...
      value: sortType => {
        switch (sortType) {
          case _const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY:
            _classPrivateFieldGet(this, _point).sort(_utils_sort__WEBPACK_IMPORTED_MODULE_7__.sortTaskByDay);

            break;

          case _const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_TIME:
            _classPrivateFieldGet(this, _point).sort(_utils_sort__WEBPACK_IMPORTED_MODULE_7__.sortTaskByDuration);

            break;

          case _const__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_PRICE:
            _classPrivateFieldGet(this, _point).sort(_utils_sort__WEBPACK_IMPORTED_MODULE_7__.sortTaskByPrice);

            break;

          default:
            _classPrivateFieldSet(this, _point, [..._classPrivateFieldGet(this, _sourcedTripPoints)]);
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        (0,_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _sortComponent), _render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.AFTERBEGIN);
    ...
    _classPrivateFieldInitSpec(this, _renderTripEvent, {
      writable: true,
      value: waypoint => {
        const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _tripEventsListElement), _classPrivateFieldGet(this, _handleTaskChange), _classPrivateFieldGet(this, _handleModeChange));
        pointPresenter.init(waypoint);

        _classPrivateFieldGet(this, _pointPresenter).set(waypoint.id, pointPresenter);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripEventsList, {
      writable: true,
      value: () => {
        for (let i = 0; i < _classPrivateFieldGet(this, _point).length; i++) {
          _classPrivateFieldGet(this, _renderTripEvent).call(this, _classPrivateFieldGet(this, _point)[i]);
        }
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderMain, {
      writable: true,
      value: () => {
        if (_classPrivateFieldGet(this, _point).length === 0) {
          _classPrivateFieldGet(this, _renderEmptyList).call(this);
        } else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createTypesMarkup": () => (/* binding */ createTypesMarkup),
/* harmony export */   "createOffersTemplateMarkup": () => (/* binding */ createOffersTemplateMarkup)
/* harmony export */ });
const createTypesMarkup = (offers, chosenPointType) => {
...
const createOffersTemplateMarkup = (offersByTypes, pointType) => {
...
const createPointEditTemplate = point => {
  ...
  const timeFrom = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(ISOFrom).format('DD/MM/YY HH:mm ');
  const timeTo = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(ISOTo).format('DD/MM/YY HH:mm');
  const pointTypeLabel = type.charAt(0).toUpperCase() + type.slice(1);
  const pointTypesMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_5__.createTypesMarkup)((0,_mock_offers__WEBPACK_IMPORTED_MODULE_4__.offers)(), type);
  const locationOptions = (0,_mock_destinations__WEBPACK_IMPORTED_MODULE_3__.destinations)().map(x => `<option value="${x.name}"></option>`).join('');
  const photosMarkup = destination.pictures.map(x => `<img className="event__photo" src="${x.src}" alt="${x.description}">`).join('');
  const editedOffersMarkup = (0,_utils_forms__WEBPACK_IMPORTED_MODULE_5__.createOffersTemplateMarkup)((0,_mock_offers__WEBPACK_IMPORTED_MODULE_4__.offers)(), type);
  return `<li class="trip-events__item">
...
class PointEditView extends _smart_view__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(_point) {
    ...
    _classPrivateFieldInitSpec(this, _setDatepicker, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _datepickerFrom, (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.element.querySelector('.event__input-start-time'), {
          enableTime: true,
        ...
        _classPrivateFieldSet(this, _datepickerTo, (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.element.querySelector('.event__input-end-time'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
...
const createEmptyListTemplate = () => `<p class="trip-events__msg">
...
const createSortTemplate = () => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__.SortType.SORT_DAY}">
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__.SortType.SORT_TIME}">
              <label class="trip-sort__btn" for="sort-time">Time</label>
            </div>

            <div class="trip-sort__item  trip-sort__item--price">
              <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__.SortType.SORT_PRICE}">
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(menuElement, new _view_menu_view__WEBPACK_IMPORTED_MODULE_0__["default"](), _render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.BEFOREEND);
(0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(filtersElement, new _view_filter_view__WEBPACK_IMPORTED_MODULE_1__["default"](), _render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.BEFOREEND);
const tripPresenter = new _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](mainElement);
tripPresenter.init(point);

if (point.length !== 0) {
  (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(menuElement, new HeaderView(point), _render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.BEFOREBEGIN);
}
})();
